...
load('..\..\MSE(MultiviewSpectralEmbbeding)\Features\MSE_SLCG_WHU.mat');
MSE=DR_HistNorm(WHU_MSE.feature);
load('..\..\..\ArticalCode\MyMvda\MvDA_GHMP\GHMP_F_MvDa\MvDA_SLCG_WHU.mat');
load('..\..\..\ArticalCode\MyMvda\MvDA_GHMP\GHMP_F_MvDa\MvDAvc_SLCG_WHU.mat');
load('..\..\S-MSE(Multi_view Spectral embedding)\SLCG\SMSE_Feature\SMSE_SLCG_WHU.mat');
...
Multi_MvFLRS_WHU_PR.AlNames=DataNames;
Multi_MvFLRS_WHU_PR.MethodNames=MethodNames;
...
save('.\ClassifierResult\Multi_WHU_Classifier_PR.mat','Multi_MvFLRS_WHU_PR');
