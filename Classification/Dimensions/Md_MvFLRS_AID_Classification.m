...
load('../../TempFeaturesDim/DMvFLRS_SLCG_AID.mat');
...
% 
Multi_MvFLRS_AID_PR.DimsNum=Dims;
Multi_MvFLRS_AID_PR.MethodName='MvFLRS';
...
Multi_MvFLRS_AID_PR.meanV=mean(Accuracy);
Multi_MvFLRS_AID_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_MvFLRS_AID_Classifier_PR.mat','Multi_MvFLRS_AID_PR');
% 
% 
% % % 
