...
load('..\..\..\..\ArticalCode\MyMvda\SLCG\SLCGfeatures\DMvDAvc_SLCG_WHU.mat');
...
% 
Multi_MvDAvc_WHU_PR.DimsNum=Dims;
Multi_MvDAvc_WHU_PR.MethodName='MvDAvc';
Multi_MvDAvc_WHU_PR.Accuracy=Accuracy;
Multi_MvDAvc_WHU_PR.R_train_all=Features.R_train_all;
Multi_MvDAvc_WHU_PR.R_test_all=Features.R_test_all;
Multi_MvDAvc_WHU_PR.meanV=mean(Accuracy);
Multi_MvDAvc_WHU_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_MvDAvc_WHU_Classifier_PR.mat','Multi_MvDAvc_WHU_PR');
% 
% 
% % % 
