...
load('..\..\..\..\ArticalCode\Co-training approach\MyCotrain\MvFLRS\SLCGFeatures\MdCotrained_AID.mat');
DimsNum=length(MdCotrainHn);
...
for i=1:DimsNum
    ClassDataC=[];
    globalfeatureall=MdCotrainHn{i};
...
% 
Multi_Cotrained_AID_PR.DimsNum=Dims;
Multi_Cotrained_AID_PR.MethodName='Cotrained';
Multi_Cotrained_AID_PR.Accuracy=Accuracy;
Multi_Cotrained_AID_PR.R_train_all=Features.R_train_all;
Multi_Cotrained_AID_PR.R_test_all=Features.R_test_all;
Multi_Cotrained_AID_PR.meanV=mean(Accuracy);
Multi_Cotrained_AID_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_Cotrained_AID_Classifier_PR.mat','Multi_Cotrained_AID_PR');
% 
% 
% % % 
