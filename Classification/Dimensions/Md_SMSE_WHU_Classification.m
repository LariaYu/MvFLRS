...
load('..\..\..\S-MSE(Multi_view Spectral embedding)\SLCG\SMSE_Feature\DSMSE_SLCG_WHU.mat');
DimsNum=length(SMSE);
...
% 
Multi_SMSE_WHU_PR.DimsNum=Dims;
Multi_SMSE_WHU_PR.MethodName='SMSE';
Multi_SMSE_WHU_PR.Accuracy=Accuracy;
Multi_SMSE_WHU_PR.R_train_all=Features.R_train_all;
Multi_SMSE_WHU_PR.R_test_all=Features.R_test_all;
Multi_SMSE_WHU_PR.meanV=mean(Accuracy);
Multi_SMSE_WHU_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_SMSE_WHU_Classifier_PR.mat','Multi_SMSE_WHU_PR');
% 
% 
% % % 
