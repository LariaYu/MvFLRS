...
% load('../../MvFLRSfeatures/DMvFLRS_SLCG_UCMerced.mat');
load('../../TempFeaturesDim/DMvFLRS_SLCG_UCMerced.mat');
...
% 
Multi_MvFLRS_UCMerced_PR.DimsNum=Dims;
Multi_MvFLRS_UCMerced_PR.MethodName='MvFLRS';
...
Multi_MvFLRS_UCMerced_PR.meanV=mean(Accuracy);
Multi_MvFLRS_UCMerced_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_MvFLRS_UCMerced_Classifier_PR.mat','Multi_MvFLRS_UCMerced_PR');
% 
% 
% % % 
