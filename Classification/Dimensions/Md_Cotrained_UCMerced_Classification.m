...
load('..\..\..\..\ArticalCode\Co-training approach\MyCotrain\MvFLRS\SLCGFeatures\MdCotrainedH_UCMerced.mat');
...
% 
Multi_Cotrained_UCMerced_PR.DimsNum=Dims;
Multi_Cotrained_UCMerced_PR.MethodName='Cotrained';
Multi_Cotrained_UCMerced_PR.Accuracy=Accuracy;
Multi_Cotrained_UCMerced_PR.R_train_all=Features.R_train_all;
Multi_Cotrained_UCMerced_PR.R_test_all=Features.R_test_all;
Multi_Cotrained_UCMerced_PR.meanV=mean(Accuracy);
Multi_Cotrained_UCMerced_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_Cotrained_UCMerced_Classifier_PR.mat','Multi_Cotrained_UCMerced_PR');
% 
% 
% % % 
