...
load('..\..\..\..\ArticalCode\MyMvda\SLCG\SLCGfeatures\DMvDA_SLCG_WHU.mat');
...
% 
Multi_MvDA_WHU_PR.DimsNum=Dims;
Multi_MvDA_WHU_PR.MethodName='MvDA';
Multi_MvDA_WHU_PR.Accuracy=Accuracy;
Multi_MvDA_WHU_PR.R_train_all=Features.R_train_all;
Multi_MvDA_WHU_PR.R_test_all=Features.R_test_all;
Multi_MvDA_WHU_PR.meanV=mean(Accuracy);
Multi_MvDA_WHU_PR.maxV=max(Accuracy);
save('.\ClassResults\Md_MvDA_WHU_Classifier_PR.mat','Multi_MvDA_WHU_PR');
% 
% 
% % % 
