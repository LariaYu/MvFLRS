...
load('../MvFLRSFeatures/MvFLRS_SG_WHU.mat');
SG=DR_HistNorm(MvFLRS);
load('../MvFLRSFeatures/MvFLRS_SL_WHU.mat');
SL=DR_HistNorm(MvFLRS);
load('../MvFLRSFeatures/MvFLRS_CG_WHU.mat');
CG=DR_HistNorm(MvFLRS);
load('../MvFLRSFeatures/MvFLRS_SC_WHU.mat');
SC=DR_HistNorm(MvFLRS);
load('../MvFLRSFeatures/MvFLRS_SLCG_WHU.mat');
MvFLRS=DR_HistNorm(MvFLRS);
Datanum='V2_WHU';
MethodNames={'SL','SC','SG','CG','MvFLRS'};
Multi_view_fetures={SL,SC,SG,CG,MvFLRS};
clear SG SC CG SL MvFLRS;
...
save('.\ClassifierResult\WHU_CV2_PR.mat','MvFLRS_WHU_PR');
